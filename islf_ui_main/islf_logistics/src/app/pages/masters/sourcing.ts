...
@Component({
  ...
  template: `
        ...
        >
          ...
          <div class="grid grid-cols-12 gap-4 mb-6">
            <div class="col-span-12 md:col-span-3">
              <label class="block font-semibold mb-1"
                >Department (Mode) <span class="text-red-500">*</span></label
              >
              <p-dropdown
                [options]="modeOptions"
                [(ngModel)]="selectedTariff.mode"
                (ngModelChange)="onDeptModeChange()"
                [ngClass]="getFieldErrorClass('mode')"
                [ngStyle]="getFieldErrorStyle('mode')"
                ...
                class="w-full"
              ></p-dropdown>
              <small *ngIf="fieldErrors['mode']" class="p-error">{{
                fieldErrors['mode']
              }}</small>
            </div>
            <div class="col-span-12 md:col-span-3">
              ...
              <p-dropdown
                ...
                [(ngModel)]="selectedTariff.shippingType"
                (ngModelChange)="
                  onFieldChange('shippingType', selectedTariff.shippingType)
                "
                [ngClass]="getFieldErrorClass('shippingType')"
                [ngStyle]="getFieldErrorStyle('shippingType')"
                ...
                class="w-full"
              ></p-dropdown>
              <small *ngIf="fieldErrors['shippingType']" class="p-error">{{
            ...
            <div class="col-span-12 md:col-span-3">
              ...
              <div class="flex gap-2">
                ...
                <button
                  pButton
                  [icon]="
                    masterDialogLoading['serviceAreaType']
                      ? 'pi pi-spin pi-spinner'
                      : 'pi pi-ellipsis-h'
                  "
                  class="p-button-sm"
                  [disabled]="masterDialogLoading['serviceAreaType']"
                  (click)="openMaster('serviceAreaType')"
                ></button>
              </div>
            </div>
            <div class="col-span-12 md:col-span-3">
              ...
              <div class="flex gap-2">
                <p-dropdown
                  ...
                  (ngModelChange)="
                    onFieldChange('serviceArea', selectedTariff.serviceArea)
                  "
                  [ngClass]="getFieldErrorClass('serviceArea')"
                  [ngStyle]="getFieldErrorStyle('serviceArea')"
              ...
              <small *ngIf="fieldErrors['serviceArea']" class="p-error">{{
            ...
            <div class="col-span-12 md:col-span-3">
              ...
              <div class="flex gap-2">
                <p-dropdown
                  ...
                  [(ngModel)]="selectedTariff.vendorType"
                  (ngModelChange)="onVendorTypeChange()"
                ...
                <button
                  pButton
                  [icon]="
                    masterDialogLoading['vendorType']
                      ? 'pi pi-spin pi-spinner'
                      : 'pi pi-ellipsis-h'
                  "
                  class="p-button-sm"
            ...
            <div class="col-span-12 md:col-span-3">
              ...
              <div class="flex gap-2">
                <p-dropdown
                  ...
                  (ngModelChange)="
                    onFieldChange('vendorName', selectedTariff.vendorName)
                  "
                ...
                <button
                  pButton
                  [icon]="
                    masterDialogLoading['vendor']
                      ? 'pi pi-spin pi-spinner'
                      : 'pi pi-ellipsis-h'
                  "
                  class="p-button-sm"
                  [disabled]="masterDialogLoading['vendor']"
                  (click)="openMaster('vendor')"
                ></button>
              </div>
              <small *ngIf="fieldErrors['vendorName']" class="p-error">{{
          ...
          <div class="grid grid-cols-12 gap-4 mb-6">
            <div class="col-span-12 md:col-span-3">
              ...
              <input
                pInputText
                [(ngModel)]="selectedTariff.code"
                (ngModelChange)="onFieldChange('code', selectedTariff.code)"
                [ngClass]="getFieldErrorClass('code')"
                [ngStyle]="getFieldErrorStyle('code')"
                [disabled]="!isManualSeries || !selectedTariff.isNew"
                [placeholder]="
                  isManualSeries
                    ? 'Enter source code'
                    : mappedTariffSeriesCode || 'Auto-generated'
                "
                class="w-full"
              />
              <small *ngIf="fieldErrors['code']" class="p-error">{{
                fieldErrors['code']
              }}</small>
            </div>
            <div class="col-span-12 md:col-span-3">
              ...
              <div class="flex gap-2">
                <p-dropdown
                  ...
                  [(ngModel)]="selectedTariff.cargoType"
                  (ngModelChange)="
                    onFieldChange('cargoType', selectedTariff.cargoType)
                  "
                  [ngClass]="getFieldErrorClass('cargoType')"
                  [ngStyle]="getFieldErrorStyle('cargoType')"
              ...
              <small *ngIf="fieldErrors['cargoType']" class="p-error">{{
            ...
            <div class="col-span-12 md:col-span-3">
              ...
              <div class="flex gap-2">
                <p-dropdown
                  ...
                  [(ngModel)]="selectedTariff.locationTypeFrom"
                  (ngModelChange)="onLocationTypeFromChange()"
                  placeholder="Select Location Type From"
                  [filter]="true"
                  filterBy="label"
                  [showClear]="true"
                  optionLabel="label"
            ...
            <div class="col-span-12 md:col-span-3">
              ...
              <div class="flex gap-2">
                <p-dropdown
                  ...
                  [(ngModel)]="selectedTariff.from"
                  (ngModelChange)="onFieldChange('from', selectedTariff.from)"
                  [ngClass]="getFieldErrorClass('from')"
                  [ngStyle]="getFieldErrorStyle('from')"
              ...
              <small *ngIf="fieldErrors['from']" class="p-error">{{
                fieldErrors['from']
              }}</small>
            </div>
            <div class="col-span-12 md:col-span-3">
              ...
              <div class="flex gap-2">
                <p-dropdown
                  appendTo="body"
                  [options]="locationTypeOptions"
                  [(ngModel)]="selectedTariff.locationTypeTo"
                  (ngModelChange)="onLocationTypeToChange()"
                  placeholder="Select Location Type To"
                  [filter]="true"
                  filterBy="label"
                  [showClear]="true"
                  optionLabel="label"
            ...
            <div class="col-span-12 md:col-span-3">
              ...
              <div class="flex gap-2">
                <p-dropdown
                  ...
                  [(ngModel)]="selectedTariff.to"
                  (ngModelChange)="onFieldChange('to', selectedTariff.to)"
                  [ngClass]="getFieldErrorClass('to')"
                  [ngStyle]="getFieldErrorStyle('to')"
              ...
              <small *ngIf="fieldErrors['to']" class="p-error">{{
                fieldErrors['to']
              }}</small>
            </div>
          </div>
          ...
          <div class="grid grid-cols-12 gap-4 mb-6">
            <div class="col-span-12 md:col-span-2">
              ...
              <div class="flex gap-2">
                <p-dropdown
                  ...
                  [(ngModel)]="selectedTariff.currency"
                  (ngModelChange)="
                    onFieldChange('currency', selectedTariff.currency)
                  "
                  [ngClass]="getFieldErrorClass('currency')"
                  [ngStyle]="getFieldErrorStyle('currency')"
              ...
              <small *ngIf="fieldErrors['currency']" class="p-error">{{
            ...
            <div class="col-span-12 md:col-span-2">
              ...
              <input
                pInputText
                type="number"
                [(ngModel)]="selectedTariff.charges"
                (ngModelChange)="
                  onFieldChange('charges', selectedTariff.charges)
                "
                [ngClass]="getFieldErrorClass('charges')"
                [ngStyle]="getFieldErrorStyle('charges')"
                class="w-full"
              />
              <small *ngIf="fieldErrors['charges']" class="p-error">{{
                fieldErrors['charges']
              }}</small>
            </div>
            ...
            <div class="col-span-12 md:col-span-2">
              ...
              <div class="relative">
                <input
                  ...
                  (ngModelChange)="
                    onFieldChange('gstVat', selectedTariff.gstVat)
                  "
                  type="text"
                  inputmode="decimal"
                ...
                />
                <span
                  class="absolute right-2 top-1/2 -translate-y-1/2 font-semibold text-gray-700 pointer-events-none"
                  >%</span
                >
              </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-8">
              ...
              <input
                pInputText
                [(ngModel)]="selectedTariff.remarks"
                (ngModelChange)="
                  onFieldChange('remarks', selectedTariff.remarks)
                "
    ...
    >
      <ng-template pTemplate="content">
        <app-service-area
          *ngIf="showServiceAreaDialog"
          (onClose)="closeMasterDialog('serviceArea')"
        ></app-service-area>
      </ng-template>
    </p-dialog>
...
export class SourcingComponent implements OnInit, OnDestroy {
  ...
  showServiceAreaTypeDialog = false;
  masterTypeFilter = '';
  ...
  filterServiceAreasByType() {
    if (this.selectedTariff && this.selectedTariff.serviceAreaType) {
      ...
      this.serviceAreaOptions = this.allServiceAreas.map((sa) => ({
        label: sa.service_area,
        value: sa.service_area,
      }));
    }
  }
  ...
  onSourceSalesChange() {
    if (this.selectedTariff && this.selectedTariff.sourceSalesCode) {
      const selected = this.sourceSalesOptions.find(
        (option) => option.value === this.selectedTariff.sourceSalesCode
      );
      if (selected) {
      ...
      next: (data) => {
        ...
        this.sources = data.map((source: any) => {
          const mappedSource = {
            ...
            // Map the type field from backend to serviceAreaType for the UI
            serviceAreaType: source.type || source.service_area_type,
            ...
            gstVat: source.gst_vat,
            remarks: source.remarks,
          };
          const startDate = this.parseDate(source.period_start_date);
          const endDate = this.parseDate(source.period_end_date);

          mappedSource.periodStartDateFormatted = startDate
            ? this.formatDateForDisplay(startDate)
            : '';
          mappedSource.periodEndDateFormatted = endDate
  ...
  saveRow() {
    ...
    if (payload.periodStartDate instanceof Date) {
      payload.periodStartDate = this.formatDateForBackend(
  ...
  onVendorTypeChange() {
    ...
    if (this.selectedTariff.vendorName) {
      const currentVendor = this.allVendors.find(
        (v) => v.vendor_no === this.selectedTariff.vendorName
      );
      if (
        currentVendor &&
        currentVendor.type !== this.selectedTariff.vendorType
      ) {
    ...
    data.forEach((row, index) => {
      try {
        ...
        const source: any = {
          ...
          locationTypeFrom:
            row['locationTypeFrom'] || row['Location Type From'] || '',
          from: row['from'] || row['From'] || '',
          locationTypeTo:
            row['locationTypeTo'] || row['Location Type To'] || '',
          to: row['to'] || row['To'] || '',
          ...
          periodStartDate:
            row['periodStartDate'] || row['Period Start Date'] || null,
