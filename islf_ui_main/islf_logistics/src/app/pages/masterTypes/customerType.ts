    ...
    <div class="card">
      ...
      >
        <ng-template pTemplate="caption">
          ...
          >
            <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Customer', action: 'write' }">
<button
              pButton
              type="button"
              label="Add Type"
...
<button
                ...
                <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Customer', action: 'delete' }">
<button
                  *ngIf="type.isNew"
                  pButton
                  icon="pi pi-trash"
