    ...
    <div class="card">
      ...
      >
        <ng-template pTemplate="caption">
          ...
          >
            <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'User Status', action: 'write' }">
<button
              pButton
              type="button"
              label="Add Type"
...
<button
                ...
                <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'User Status', action: 'delete' }">
<button
                  *ngIf="type.isNew"
                  pButton
                  icon="pi pi-trash"
...
export class userStatusComponent implements OnInit, OnDestroy {
  ...
  addRow() {
    ...
    const newRow = {
      id: null,
      key: this.masterType || 'USER_STATUS',
      value: '',
      description: '',
      status: 'Active',
      isEditing: true,
