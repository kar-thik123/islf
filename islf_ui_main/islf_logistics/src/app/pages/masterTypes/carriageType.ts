    ...
    <div class="card">
      ...
      >
        <ng-template pTemplate="caption">
          ...
          >
            <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Carriage', action: 'write' }">
<button
              pButton
              type="button"
              label="Add Type"
...
<button
                ...
                <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Carriage', action: 'delete' }">
<button
                  *ngIf="type.isNew"
                  pButton
                  icon="pi pi-trash"
...
export class carriageTypeComponent implements OnInit, OnDestroy {
  @Input() filterByKey: string = ''; // Filter types by specific key
  types: any[] = [];
  masterType: string = 'CARRIAGE';
  activeTypes: any[] = [];
