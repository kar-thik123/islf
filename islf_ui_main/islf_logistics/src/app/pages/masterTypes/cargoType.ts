    ...
    <div class="card">
      ...
      >
        <ng-template pTemplate="caption">
          ...
          >
            <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Cargo Type', action: 'write' }">
<button
              pButton
              type="button"
              label="Add Type"
...
<button
                ...
                <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Cargo Type', action: 'delete' }">
<button
                  *ngIf="type.isNew"
                  pButton
                  icon="pi pi-trash"
...
export class cargoTypeComponent implements OnInit, OnDestroy {
  ...
  addRow() {
    ...
    const newRow = {
      id: null,
      key: this.masterType || 'CARGO_TYPE',
      value: '',
      description: '',
      status: 'Active',
      isEditing: true,
