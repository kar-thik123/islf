    ...
    <div class="card">
      ...
      >
        <ng-template pTemplate="caption">
          ...
          >
            <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Tariff Type', action: 'write' }">
<button
              pButton
              type="button"
              label="Add Type"
...
<button
                ...
                <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Tariff Type', action: 'delete' }">
<button
                  *ngIf="type.isNew"
                  pButton
                  icon="pi pi-trash"
...
export class tariffTypeComponent implements OnInit, OnDestroy {
  @Input() filterByKey: string = ''; // Filter types by specific key
  types: any[] = [];
  masterType: string = 'TARIFF_TYPE';
  activeTypes: any[] = [];
  ...
  addRow() {
    ...
    const newRow = {
      id: null,
      key: this.masterType || 'TARIFF_TYPE',
      value: '',
      description: '',
      status: 'Active',
      isEditing: true,
