  ...
  template: `
    ...
    <div class="card">
      ...
      <p-table
        ...
        [showGridlines]="true"
        [rowHover]="true"
        [globalFilterFields]="['key', 'value', 'status']"
      ...
      >
        <ng-template pTemplate="caption">
          ...
          >
            <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Location', action: 'write' }">
<button
              pButton
              type="button"
              label="Add Type"
...
<button
                ...
                <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Location', action: 'delete' }">
<button
                  *ngIf="type.isNew"
                  pButton
                  icon="pi pi-trash"
