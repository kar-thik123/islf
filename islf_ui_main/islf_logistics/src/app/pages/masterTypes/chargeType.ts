    ...
    <div class="card">
      ...
      >
        <ng-template pTemplate="caption">
          ...
          >
            <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Charge Type', action: 'write' }">
<button
              pButton
              type="button"
              label="Add Type"
...
<button
                ...
                <ng-container *appHasPermission="{ module: 'Master Types', subModule: 'Charge Type', action: 'delete' }">
<button
                  *ngIf="type.isNew"
                  pButton
                  icon="pi pi-trash"
...
export class chargeTypeComponent implements OnInit, OnDestroy {
  @Input() filterByKey: string = ''; // Filter types by specific key
  types: any[] = [];
  masterType: string = 'CHARGE_TYPE';
  activeTypes: any[] = [];
  ...
  addRow() {
    ...
    const newRow = {
      id: null,
      key: this.masterType || 'CHARGE_TYPE',
      value: '',
      description: '',
      status: 'Active',
      isEditing: true,
