...
var {
  toString: toString2,
  hasOwnProperty: hasOwnProperty6
} = Object.prototype;
    ...
    QueryManager2.prototype.getObservableFromLink = function(query, context, variables, extensions, deduplication) {
      ...
      if (serverQuery) {
        ...
        if (deduplication) {
          ...
          if (!observable) {
            var concast_1 = new Concast([execute2(link, operation)]);
          ...
          observable = new Concast([execute2(link, operation)]);
        }
      } else {
...
//# sourceMappingURL=chunk-6WBHYM4P.js.map
