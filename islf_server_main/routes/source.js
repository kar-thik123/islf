  ...
  try {
    ...
    const duplicateCheckQuery = `
      ...
      WHERE mode = $1 
        ...
        AND (gst_vat = $23 OR (gst_vat IS NULL AND $23 IS NULL))
        AND (remarks = $24 OR (remarks IS NULL AND $24 IS NULL))
        AND (type = $25 OR (type IS NULL AND $25 IS NULL))
      LIMIT 1
    `;
    ...
    const result = await pool.query(
      `INSERT INTO sourcing (
        ...
        company_code, branch_code, department_code,created_by,service_area,source_sales_code,gst_vat,remarks,type
      ) VALUES (
...
router.put('/:id', async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query(
      `UPDATE sourcing SET
        code = $1, mode = $2, shipping_type = $3, cargo_type = $4, basis = $5, item_name = $6, location_type_from = $7, location_type_to = $8, from_location = $9, to_location = $10, vendor_type = $11, vendor_name = $12, currency = $13, charges = $14, effective_date = $15, period_start_date = $16, period_end_date = $17,
